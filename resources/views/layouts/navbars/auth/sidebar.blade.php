<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header h-auto">
        ...
        <a class="align-items-center d-flex justify-content-center m-0 navbar-brand text-wrap p-1" href="{{ route('dashboard') }}">
            <img src="../assets/img/logo_jai_yazaki.png" class="navbar-brand-img mh-100" alt="...">
        </a>
        <div class="h-auto">
        ...
        <ul class="navbar-nav">
                ...
                <a class="nav-link {{ Request::is('dashboard') ? 'active' : '' }}" href="{{ url('dashboard') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;"
                            class="fas fa-lg fa-store ps-2 pe-2 text-center text-dark {{ Request::is('dashboard') ? 'text-white' : 'text-dark' }} "
                            aria-hidden="true"></i>
                    </div>
            ...
            <li class="nav-item pb-2">
                <a class="nav-link {{ Request::is('billing') ? 'active' : '' }}" href="{{ url('billing') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;"
                            class="fas fa-lg fa-search ps-2 pe-2 text-center text-dark {{ Request::is('billing') ? 'text-white' : 'text-dark' }} "
                            aria-hidden="true"></i>
                    </div>
                    <span class="nav-link-text ms-1">Pencarian License</span>
                </a>
            </li>
            <li class="nav-item pb-2">
